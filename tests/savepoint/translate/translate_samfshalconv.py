...
class TranslateShalConv(TranslatePhysicsFortranData2Py):
    def __init__(self, grid, namelist, stencil_factory):
        ...
        self.in_vars["data_vars"] = {
            ...
            "kbot": {"serialname": "sc_kbot", "shield": True},
            "ktop": {"serialname": "sc_ktop", "shield": True},
            ...
            "ncld": {"serialname": "sc_ncld", "shield": True},
    ...
    def compute(self, inputs):
        ...
        config = ShallowConvectionConfig(
            ...
            ntke=inputs.pop("sc_ntk") - 1,
            nsamftrac=inputs.pop("sc_nsamftrac"),
            ncld=inputs.pop("sc_ncld"),
            ntchm=inputs.pop("sc_ntchm"),
            ntiw=0,
            ntcw=1,
            itc=inputs.pop("sc_itc") - 1,
