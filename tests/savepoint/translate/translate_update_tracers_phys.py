...
class TranslatePhysUpdateTracers(TranslatePhysicsFortranData2Py):
    def __init__(self, grid, namelist, stencil_factory):
        ...
        self.in_vars["data_vars"] = {
            ...
            "v_t0": {"order": "F"},
            "pt_t0": {"order": "F"},
            "qvapor_t0": {"dycore": True, "kend": self.config.npz - 1},
            "qliquid_t0": {"dycore": True, "kend": self.config.npz - 1},
            "qrain_t0": {"dycore": True, "kend": self.config.npz - 1},
            "qsnow_t0": {"dycore": True, "kend": self.config.npz - 1},
            "qice_t0": {"dycore": True, "kend": self.config.npz - 1},
            "qgraupel_t0": {"dycore": True, "kend": self.config.npz - 1},
