...
class TranslateIceCloud(TranslatePhysicsFortranData2Py):
    def __init__(
        ...
        self.out_vars = {
            "qvapor": {"serialname": "ic_qv", "kend": self.config.npz, "shield": True},
            "qliquid": {"serialname": "ic_ql", "kend": self.config.npz, "shield": True},
            "qrain": {"serialname": "ic_qr", "kend": self.config.npz, "shield": True},
            "qice": {"serialname": "ic_qi", "kend": self.config.npz, "shield": True},
            "qsnow": {"serialname": "ic_qs", "kend": self.config.npz, "shield": True},
            "qgraupel": {
                "serialname": "ic_qg",
