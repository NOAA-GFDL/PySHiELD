...
class TranslateSubgridZProc(TranslatePhysicsFortranData2Py):
    def __init__(
        ...
        self.out_vars = {
            "qvapor": {"serialname": "sz_qv", "kend": self.config.npz, "shield": True},
            "qliquid": {"serialname": "sz_ql", "kend": self.config.npz, "shield": True},
            "qrain": {"serialname": "sz_qr", "kend": self.config.npz, "shield": True},
            "qice": {"serialname": "sz_qi", "kend": self.config.npz, "shield": True},
            "qsnow": {"serialname": "sz_qs", "kend": self.config.npz, "shield": True},
            "qgraupel": {
                "serialname": "sz_qg",
            ...
            "cond": {"serialname": "sz_cond", "kend": self.config.npz, "shield": True},
            "dep": {"serialname": "sz_dep", "kend": self.config.npz, "shield": True},
            "reevap": {
                "serialname": "sz_reevap",
                "kend": self.config.npz,
                "shield": True,
            },
            "sub": {"serialname": "sz_sub", "kend": self.config.npz, "shield": True},
        }
