...
from ...pySHiELD.radiation.rad_astro import sol_init, read_NOAA_solar_file
...
@pytest.mark.parameterize(
    ...
    pytest.param(0, 1990, 1.3660e3, id="old_constant",),
    pytest.param(10, 1990, 1.3608e3, id="new_constant",),
    pytest.param(2, 1990, 0.0, id="data_read",),
)
